...
const ARSENAL_FEATURES = [
    ...
    { icon: Zap, title: 'Calculus Survival Kit', desc: 'Step-by-step prompts to explain differentiation, integration, and DEs.' },
    { icon: BookOpen, title: 'The AI Student Stack', desc: 'The best free AI tools to crush your engineering courses.' },
];
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden" style={{ fontFamily: "'Manrope', ui-sans-serif, system-ui, sans-serif" }}>
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-black/70 backdrop-blur-xl border-b border-white/[0.05]">
                ...
                <div className="text-sm font-bold bg-white/[0.05] text-gray-400 px-4 py-2 rounded-xl border border-white/[0.05]">
            ...
            <section className="relative pt-32 pb-16 px-6">
                ...
                <div className="max-w-2xl mx-auto text-center relative z-10">
                    ...
                    <p className="text-lg text-gray-400 max-w-lg mx-auto mb-10 leading-relaxed">
                        AI hacks, a focus protocol, and a calculus survival kit built <span className="text-white font-semibold">specifically for UMaT engineering students.</span> Free. No login required.
                    </p>
                ...
                <div className="max-w-md mx-auto">
                    {submitted ? (
                        <div className="text-center p-8 rounded-3xl bg-white/[0.03] border border-white/[0.08]">
                            ...
                            <div className="mt-6 inline-flex items-center gap-2 bg-blue-500/10 text-blue-400 font-bold text-sm px-6 py-3 rounded-xl border border-blue-500/20">
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="mb-10 p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-base font-black">Section 3: The Calculus Survival Kit</h3>
                                <p className="text-gray-500 text-xs">Step-by-step prompts to survive the hardest engineering math.</p>
                            </div>
                        </div>
                        <div className="space-y-2">
                            {[
                                '📉 The Differentiation Explainer — Power, product, and chain rule breakdowns',
                                '∫ The Integration Solver — Identifies the exact technique (by parts, partial fractions)',
                                '📈 The Limits & L\'Hôpital Prompt — For indeterminate forms like 0/0',
                                '〰️ Differential Equations Breakdown — Classifies and solves DEs step-by-step',
                            ].map((item) => (
                    ...
                    <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-base font-black">Section 4: The Ultimate AI Student Stack</h3>
                                <p className="text-gray-500 text-xs">The best free AI tools to use alongside your prompts.</p>
                            </div>
                        </div>
                        <div className="space-y-2">
                            {[
                                '📚 NotebookLM — Upload course slides and ask questions directly from your notes',
                                '⚡ Claude 3.5 Sonnet — Much better at complex math and C++/Python code than ChatGPT',
                                '🔍 Perplexity AI — Research engine that cites real sources (no hallucination)',
                                '🎨 Gamma App — Generate beautiful presentations for group projects in seconds',
                            ].map((item) => (
                                <p key={item} className="text-sm text-gray-400">{item}</p>
                            ))}
                        </div>
            ...
            <section className="py-20 px-6 border-t border-white/[0.05]">
                <div className="max-w-md mx-auto text-center">
                    <h2 className="text-3xl font-black mb-3">The Platform is <span className="text-blue-500">Launching Soon.</span></h2>
                    <p className="text-gray-400 text-sm mb-6">Join 76+ UMaT students already locking in. Download the free Arsenal above to join the waitlist.</p>
                    <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="inline-flex items-center gap-2 bg-white text-black font-bold text-sm px-8 py-3.5 rounded-2xl hover:bg-gray-200 transition-all active:scale-95">
                        Get The Free Arsenal 🚀
                    </button>
                </div>
            </section>
