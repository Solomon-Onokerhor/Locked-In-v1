// Auto-generated from bible-strong-avatar-lab studio export
// Avatar: Grok bot (black sphere, white eyes)
import type { AvatarData } from './avatar-runtime'

export type AnimationName = 'sleeping' | 'waking' | 'idle' | 'listening' | 'thinking' | 'searching' | 'working' | 'excited' | 'bored' | 'suspicious' | 'angry' | 'drowsy' | 'happy' | 'curious' | 'confused' | 'surprised' | 'proud' | 'shy' | 'sad' | 'laughing' | 'scared' | 'playful' | 'celebrate'

export const avatarData: AvatarData<AnimationName> = {
  "version": 1,
  "avatar": {
    "name": "Grok bot",
    "surface": {
  ...
  "expressions": {
    ...
    "expression-3d2bed26-f97c-477d-922f-77600cb10e92": {
    ...
    "expression-5220eaee-32fe-4bd8-ad31-432189534cc8": {
