...
server.tool("clerk_update_user_metadata", "Update a user's public or private metadata", {
    ...
    publicMetadata: zod_1.z.record(zod_1.z.any()).optional().describe("Public metadata to set/merge"),
    privateMetadata: zod_1.z.record(zod_1.z.any()).optional().describe("Private metadata to set/merge"),
